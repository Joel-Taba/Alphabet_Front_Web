...
//#region node_modules/.nitro/vite/services/ssr/assets/ExerciseCompletePopup-CtcMpMlQ.js
...
* `EvaluationCompleteOverlay`). Laisse l'enfant choisir entre enchaîner
* directement sur le cours suivant ou revenir à l'accueil, pour pouvoir
* parcourir tout un palier sans jamais devoir repasser par l'accueil.
*
...
*/
function ExerciseCompletePopup({ onBackHome, onNext }) {
	const { t } = useLanguage();
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [onNext && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: onNext,
