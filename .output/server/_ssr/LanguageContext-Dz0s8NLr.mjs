...
//#region node_modules/.nitro/vite/services/ssr/assets/LanguageContext-Dz0s8NLr.js
...
var fr = {
	...
	evaluation: {
		...
		finishedMessage: "Le temps est écoulé. Tu as bien travaillé sur cette évaluation.",
	...
	errorPage: {
		...
		body: "Quelque chose s'est mal passé de notre côté. Tu peux réessayer ou revenir à l'accueil.",
		retry: "Réessayer",
		goHome: "Accueil"
	},
	welcome: {
	...
	profileHub: {
		...
		voiceGenderOptions: [{
			label: "Voix Homme",
			desc: "Douce et chaleureuse"
		}, {
			label: "Voix Femme",
			desc: "Douce et chaleureuse"
		}],
		voiceGenderTest: "Écouter un exemple",
		voiceGenderTestPhrase: "Coucou, c'est Amani ! On continue à apprendre ensemble ?",
		...
		evaluationDurationHint: "Temps donné pour l'évaluation chronométrée de fin de palier",
	...
	coursScreen: {
		...
		intro: "Voici les 4 signes fondamentaux de la méthode Flores Gong Nota. Touche une carte pour explorer toutes ses variantes.",
	...
	coursLettres: {
		...
		intro: "Lettres et Chiffres. Chaque lettre est formée en assemblant les signes fondamentaux. Touche une lettre pour voir sa formule !",
		...
		chiffresSubtitle: "0–4 validés · 5–9 en cours de validation avec M. Moussa",
		majusculesTitle: "Majuscules (A – Z)",
		majusculesSubtitle: "⚠️ Formules à valider avec M. Moussa avant usage pédagogique",
	...
	coursLettresChar: {
		...
		pendingWarning: "Cette formule est une reconstruction visuelle et doit être validée par Monsieur Moussa avant d'être utilisée dans les exercices pédagogiques.",
		seenOnLines: "Aperçu sur les lignes",
		formulaTitle: "Formule",
		signeCount: "{count} signe(s) · Touche un signe pour en savoir plus",
		result: "Résultat",
		adqNote: "Attention : Les lettres a, d et q utilisent la même formule de signes. C'est la position du trait vertical (corps / hampe / jambe) qui les distingue — pas les signes eux-mêmes.",
	...
	coursFormation: {
		...
		intro: "Bienvenue dans la combinatoire ! Ici, tu vas apprendre à combiner les signes pour former des lettres et des chiffres.",
		magicTitle: "La magie de la combinatoire !",
		magicBody: "Chaque lettre est formée en assemblant les signes que tu as appris : traits, courbes, crochets et points. Touche un groupe pour commencer !",
		previewTitle: "Aperçu",
		signeCount: "{count} signe(s)"
	},
	coursFormationChar: {
	...
	exercice: {
		...
		replay: "Réécouter",
		helpText: "La <b>Courbe</b>, c'est un arc doux comme un pont, en couleur verte.",
	...
	exerciceSyllabes: {
		...
		introBody: "Trace la consonne puis la voyelle pour former chaque syllabe.",
...
var en = {
	...
	modeLibre: {
		...
		helpText: "Pick a model if you want some inspiration, then draw it from memory on the blank page. Clear it and start over as many times as you like!",
		tabs: {
			scribble: "Scribble",
			sign: "Sign",
			letter: "Letter",
	...
	community: {
		...
		you: "me",
		amaniQuote: "Everyone grows at their own pace, what matters is moving forward.",
	...
	profileHub: {
		...
		photoHint: "It will show up next to your name on the Clearing leaderboard.",
	...
	coursScreen: {
		...
		intro: "Here are the 4 fundamental signs of the Flores Gong Nota method. Tap a card to explore all its variants.",
	...
	coursLettres: {
		...
		intro: "Letters and Numbers. Each letter is formed by combining the fundamental signs. Tap a letter to see its formula!",
		legendSuffix: "dominant",
		minusculesTitle: "Lowercase (a – z)",
		minusculesSubtitle: "Source: CP1 Manual — validated formulas",
		chiffresTitle: "Numbers (0 – 9)",
		chiffresSubtitle: "0–4 validated · 5–9 pending validation with Mr. Moussa",
		majusculesTitle: "Uppercase (A – Z)",
		majusculesSubtitle: "⚠️ Formulas to be validated with Mr. Moussa before pedagogical use",
	...
	coursLettresChar: {
		...
		pendingWarning: "This formula is a visual reconstruction and must be validated by Mr. Moussa before being used in the lessons.",
		seenOnLines: "Preview on the lines",
		formulaTitle: "Formula",
		signeCount: "{count} sign(s) · Tap a sign to learn more",
		result: "Result",
		adqNote: "Note: The letters a, d and q use the same formula of signs. It's the position of the vertical line (body / ascender / descender) that tells them apart — not the signs themselves.",
	...
	coursFormation: {
		...
		intro: "Welcome to combinatorics! Here, you'll learn to combine signs to form letters and numbers.",
		magicTitle: "The magic of combinatorics!",
		magicBody: "Every letter is formed by assembling the signs you've learned: lines, curves, hooks and dots. Tap a group to start!",
...
var es = {
	...
	evaluation: {
		...
		finishedMessage: "Se acabó el tiempo. Has trabajado muy bien en esta evaluación.",
	...
	errorPage: {
		...
		body: "Algo salió mal de nuestro lado. Puedes intentarlo de nuevo o volver al inicio.",
		retry: "Reintentar",
		goHome: "Inicio"
	},
	welcome: {
	...
	profileLock: {
		...
		subtitle: "Introduce la contraseña definida al registrarte para continuar.",
	...
	modeLibre: {
		...
		helpText: "Elige un modelo si quieres inspirarte, luego dibújalo de memoria en la página en blanco. ¡Bórralo y vuelve a empezar todas las veces que quieras!",
		tabs: {
			scribble: "Garabato",
			sign: "Signo",
			letter: "Letra",
	...
	parcours: {
		...
		subtitle: "Sigue el camino en zigzag y haz florecer los brotes paso a paso.",
		start: "Comenzar",
	...
	profileHub: {
		...
		evaluationDurationHint: "Tiempo dado para la evaluación cronometrada de fin de nivel",
	...
	coursScreen: {
		...
		intro: "Aquí están los 4 signos fundamentales del método Flores Gong Nota. Toca una tarjeta para explorar todas sus variantes.",
	...
	coursFamily: {
		intro: "Aquí está la lección sobre {title}. Toca una tarjeta abajo para ver cómo trazar cada variante.",
	...
	coursLettres: {
		...
		intro: "Letras y Números. Cada letra se forma combinando los signos fundamentales. ¡Toca una letra para ver su fórmula!",
		...
		chiffresSubtitle: "0–4 validados · 5–9 en proceso de validación con el Sr. Moussa",
		majusculesTitle: "Mayúsculas (A – Z)",
		majusculesSubtitle: "⚠️ Fórmulas por validar con el Sr. Moussa antes de su uso pedagógico",
	...
	coursLettresChar: {
		...
		pendingWarning: "Esta fórmula es una reconstrucción visual y debe ser validada por el Sr. Moussa antes de usarse en los ejercicios pedagógicos.",
		seenOnLines: "Vista previa en las líneas",
		formulaTitle: "Fórmula",
		signeCount: "{count} signo(s) · Toca un signo para saber más",
		result: "Resultado",
		adqNote: "Atención: Las letras a, d y q usan la misma fórmula de signos. Es la posición del trazo vertical (cuerpo / asta ascendente / asta descendente) lo que las distingue, no los signos en sí.",
	...
	coursFormation: {
		...
		intro: "¡Bienvenido a la combinatoria! Aquí aprenderás a combinar los signos para formar letras y números.",
		magicTitle: "¡La magia de la combinatoria!",
		magicBody: "Cada letra se forma ensamblando los signos que has aprendido: trazos, curvas, ganchos y puntos. ¡Toca un grupo para empezar!",
	...
	exercice: {
		...
		replay: "Reescuchar",
		helpText: "La <b>Curva</b> es un arco suave como un puente, de color verde.",
	...
	exerciceListe: {
		...
		introGroup: "¡Aquí está el cuaderno de escritura para {titre}! Elige un carácter para practicar formándolo signo por signo.",
		groupHint: "¡Toca un carácter abajo para practicar en la cuadrícula Seyès con validación de cada gesto!",
		...
		introGeneral: "¡Bienvenido al cuaderno de escritura! Repasa las líneas punteadas siguiendo el punto verde para aprender a trazar cada signo correctamente.",
		repetitionsLabel: "Repeticiones por signo",
		repetitionsHint: "Número de veces que hay que trazar cada signo en la línea",
		toleranceLabel: "Tolerancia de validación",
		toleranceHint: "Más alta = más fácil para los más pequeños",
		startHint: "El punto verde indica el punto de partida. Sigue las líneas punteadas levantando el dedo lo menos posible.",
		done: "¡Terminado!",
		rowComplete: "¡Bien hecho! Has trazado todos los signos de esta línea. ¡Excelente trabajo!",
	...
	exerciceLettre: {
		...
		practiceStepsHint: "Consigue cada signo {reps} veces antes de escribir la letra completa.",
		finalTitle: "Escribe la letra completa",
		finalHint: "Ahora traza todos los signos seguidos, como para escribir la letra de verdad.",
		finalLocked: "Termina primero todos los signos de arriba para desbloquear esta etapa.",
		...
		speakLetterDone: "¡Bien hecho! ¡Has formado perfectamente la letra {name}!",
	...
	exerciceSyllabes: {
		...
		introBody: "Traza la consonante y luego la vocal para formar cada sílaba.",
	...
	coursMots: {
		...
		introSpeak: "Aquí está la lección sobre {titre}. Toca el altavoz de cada palabra para escucharla.",
		introTitle: "Escucha y observa cada palabra",
		introBody: "Cada palabra ya está escrita con letras que conoces. ¡Toca el altavoz para escucharla!",
	...
	motsCroises: {
		...
		hintBody: "¡Escucha cada palabra de abajo y traza sus letras en la cuadrícula, como un verdadero crucigrama!",
	...
	modeLibreCroises: {
		...
		intro: "¡Toca «Nueva cuadrícula» para sacar palabras al azar y jugar al crucigrama todas las veces que quieras!",
...
var ar = {
	...
	coursMots: {
		...
		introSpeak: "إليك درس {titre}. المس مكبر الصوت لكل كلمة لسماعها.",
		introTitle: "استمع وشاهد كل كلمة",
		introBody: "كل كلمة مكتوبة بالفعل بالحروف التي تعرفها. المس مكبر الصوت لسماعها!",
...
var STORAGE_KEY = "amani_setting_lang";
var dictionaries = {
	fr,
	en,
	es,
...
var RTL_LANGS = /* @__PURE__ */ new Set(["ar"]);
...
//#endregion
export { useLanguage as i, SPEECH_LOCALE as n, format as r, LanguageProvider as t };
