...
//#region node_modules/.nitro/vite/services/ssr/assets/LetterTraceCell-7ZmKd7P4.js
...
*/
function LetterTraceCell({ letter, size = 84, isActive, given = false, onSolved }) {
	...
	(0, import_react.useEffect)(() => {
		if (activeStep && !solved) refPointsRef.current = sampleSVGPath(activeStep.pathD, 40);
	}, [activeStep, solved]);
	(0, import_react.useEffect)(() => {
	...
	const drawCompleted = (0, import_react.useCallback)(() => {
		const canvas = canvasRef.current;
		if (!canvas) return;
		const ctx = canvas.getContext("2d");
		if (!ctx) return;
	...
	const handlePointerUp = (e) => {
		...
		if (validateTrace(userPointsRef.current, refPointsRef.current, TOLERANCE_PX).valid) {
			const newCompleted = [...completedSteps, {
				stepIdx: currentStepIdx,
				strokeColor: activeStep.strokeColor
			}];
			setCompletedSteps(newCompleted);
			if (currentStepIdx + 1 < letter.steps.length) setTimeout(() => setCurrentStepIdx((idx) => idx + 1), 350);
			else {
				setStatus("solved");
				onSolved?.();
			}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("relative shrink-0 rounded-[10px] border-2 overflow-hidden transition-colors", given ? "bg-[#FBF6EC] border-[#A9784F]/40" : solved ? "bg-white border-[#8FBF6F]" : isActive ? "bg-white border-[#A9784F]/50" : "bg-white border-[#4A3B2A]/12"),
		style: {
			width: w,
			height: h
		},
		children: given ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			!solved && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
				viewBox: "0 0 200 200",
				...
				children: zOrderedStepIndices(letter.steps).map((idx) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
						...
						fill: "none",
						opacity: isCurrentStep ? .85 : .3
					}, idx);
				})
			}),
			isActive && !solved && (status === "idle" || status === "retry") && activeStep && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("canvas", {
				...
				className: cn("absolute inset-0 w-full h-full touch-none z-20", isActive && !solved ? "cursor-crosshair" : "cursor-default")
			})
		] })
	});
}
//#endregion
export { LetterTraceCell as t };
