...
import { t as SignGlyph } from "./SignGlyph-Mvm76R8D.mjs";
...
import { t as Route } from "./cours._family-Df0HROX5.mjs";
import { n as FAMILY_ORDER, t as EXERCISE_CATALOG } from "./sign-exercise-catalog-2qXNd-Hz.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cours._family-Dt9wNy3e.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				...
				children: entries.map((item) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("flex flex-col items-center justify-between p-3.5 rounded-2xl border-2 transition-all duration-200 text-left select-none relative overflow-hidden min-h-[170px]", isSelected ? "border-secondary bg-[#FBF6EC] shadow-lg scale-[1.02]" : "border-gray-200 bg-white hover:border-gray-300 shadow-sm active:scale-98"),
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [prevFamily ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "h-4 w-4" }), t.common.back]
