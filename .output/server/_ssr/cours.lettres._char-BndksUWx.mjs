...
import { B as BookOpen, U as ArrowLeft, n as Volume2 } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./cours.lettres._char-Bj7gBqGv.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cours.lettres._char-BndksUWx.js
...
function DecompositionScreen() {
	...
	const speechText = formule.validee ? `${nom}. ${format(t.coursLettresChar.signeCount, { count: formule.signes.length })}: ${formule.signes.map((s) => `${t.coursLettresChar.families[s.famille]} ${t.coursLettresChar.variants[s.variante] ?? s.variante}`).join(", ")}.` : `${nom}. ${t.coursLettresChar.pendingWarning}`;
