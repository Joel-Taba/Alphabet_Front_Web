...
import { t as Route } from "./cours.mots._groupId-Du1dvKFV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cours.mots._groupId-B7tvqYgG.js
...
function WordCourseScreen() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(MobileShell, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			type: "button",
			onClick: () => speak(format(t.coursMots.introSpeak, { titre: groupTitle })),
			"aria-label": t.common.instruction,
			className: "grid h-10 w-10 place-items-center rounded-full bg-[#4A90E2] text-white shadow-[0_2px_6px_rgba(74,59,42,0.18)] active:scale-95 transition-transform",
