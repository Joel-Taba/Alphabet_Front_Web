...
import { n as findSyllableGroupForConsonant, r as lettersForExampleWord, t as SYLLABLE_GROUPS } from "./syllable-catalog-7anoMDUA.mjs";
...
import { t as Route } from "./cours.syllabes._consonant-CwvBYtjC.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/cours.syllabes._consonant-CTl4c4jK.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [syllableIdx > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "h-4 w-4 rtl:rotate-180" }),
						"\"",
					...
					children: [
						...
						group.syllables[syllableIdx + 1].syllable,
						"\"",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-4 w-4 rtl:rotate-180" })
					]
					...
					className: "flex items-center gap-2 px-5 py-3 rounded-full bg-[#A9784F] text-white font-bold text-[14px] shadow-md active:scale-95 transition-transform",
					children: [format(t.coursSyllabes.nextConsonant, { consonant: nextConsonantGroup.consonant }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "h-4 w-4 rtl:rotate-180" })]
