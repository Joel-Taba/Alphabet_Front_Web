...
import { P as ChevronRight, U as ArrowLeft, w as Lock } from "../_libs/lucide-react.mjs";
...
import { a as VOWELS, o as getLetterFormation } from "./letter-style-resolver-DOxN1AFB.mjs";
import { i as lettersForGroup, n as getPalier2GroupMap, r as getPalier2Groups, t as findGroupForChar } from "./palier2-groups-Fh5LUE31.mjs";
import { i as zOrderedStepIndices, r as stepZIndex } from "./SignGlyph-BH0B_An9.mjs";
...
import { t as RepetitionRow } from "./RepetitionRow-BmlwYseo.mjs";
import { n as EvaluationTimerBadge, r as useCountdown, t as EvaluationCompleteOverlay } from "./EvaluationTimer-BH-3up6U.mjs";
import { t as Route } from "./exercice.lettre._char-KOd066Hr.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/exercice.lettre._char-DbmKVaHR.js
...
function LetterExerciseScreen() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(MobileShell, { children: [
					...
					children: letter.steps.map((step, i) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RepetitionRow, {
							...
							badge: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "grid h-7 w-7 shrink-0 place-items-center rounded-full bg-[#A9784F] text-white text-[16px] font-extrabold leading-none",
								children: i + 1
							}),
							repetitions,
							tolerance,
						...
						}, `${letter.char}-step-${i}-r${restartKey}`);
					})
				}),
		...
		letterSuccess && isEvaluation && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LetterSuccessOverlay, {
			letter,
			nextLetter,
			groupId,
			isEvaluation,
...
function LetterDrawingCanvas({ letter, currentStepIdx, completedSteps, stepStatus, onStepStatusChange, onSuccess, onRetry, w, h }) {
	...
	const drawAll = (0, import_react.useCallback)(() => {
		...
		const ox = (w - 200 * sc) / 2;
		const oy = (h - 200 * sc) / 2;
		const zOrderedCompleted = [...completedSteps].sort((a, b) => stepZIndex(letter.steps[a.stepIdx] ?? { family: "courbe" }) - stepZIndex(letter.steps[b.stepIdx] ?? { family: "courbe" }));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CahierFrame, {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("svg", {
				...
				children: zOrderedStepIndices(letter.steps).map((idx) => {
					...
					children: [
						nextLetter && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
								...
								nextLetter.char,
								")"
							] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronRight, { className: "w-4 h-4 stroke-[3] rtl:rotate-180" })]
						}),
