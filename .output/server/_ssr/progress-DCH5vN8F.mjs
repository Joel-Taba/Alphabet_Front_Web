...
//#region node_modules/.nitro/vite/services/ssr/assets/progress-DCH5vN8F.js
...
var BONUS_STORAGE_KEY = "amani_progress_bonus_points";
var RESTART_BONUS_MIN = 1;
var RESTART_BONUS_MAX = 2;
function readBonusTotal() {
	if (typeof localStorage === "undefined") return 0;
	const raw = localStorage.getItem(BONUS_STORAGE_KEY);
	const n = raw != null ? Number(raw) : 0;
	return Number.isFinite(n) ? n : 0;
}
function writeBonusTotal(total) {
	if (typeof localStorage === "undefined") return;
...
*/
function awardRestartBonus() {
	const points = Math.random() < .5 ? RESTART_BONUS_MIN : RESTART_BONUS_MAX;
...
//#endregion
export { useProgressStats as a, onPointsAwarded as i, awardRestartBonus as n, markCoursItemViewed as r, awardCompletion as t };
