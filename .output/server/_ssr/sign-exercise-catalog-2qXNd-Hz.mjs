//#region node_modules/.nitro/vite/services/ssr/assets/sign-exercise-catalog-2qXNd-Hz.js
var TRAITS = [
	{
...
new Map(EXERCISE_CATALOG.map((e) => [e.id, e]));
...
//#endregion
export { FAMILY_ORDER as n, EXERCISE_CATALOG as t };
