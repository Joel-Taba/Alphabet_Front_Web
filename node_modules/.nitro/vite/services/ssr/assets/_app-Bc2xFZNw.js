...
import { Leaf, MoreVertical, Palette, User, Users } from "lucide-react";
//#region src/components/amani/BottomNav.tsx
var allItems = [
	{
		to: "/accueil",
		key: "accueil",
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: activeIndex >= 0 && (() => {
							...
							return /* @__PURE__ */ jsx(ActiveIcon, {
                 ...
                 Z`,
					...
					children: allItems.map(({ to, key, icon: Icon }, index) => {
						...
						return /* @__PURE__ */ jsxs(Link, {
							...
							children: [
								/* @__PURE__ */ jsx("span", { className: "absolute -top-1 h-0.5 w-4 rounded-full bg-secondary opacity-0 transition-opacity duration-200 group-data-[status=active]:opacity-100" }),
								/* @__PURE__ */ jsx(Icon, {
