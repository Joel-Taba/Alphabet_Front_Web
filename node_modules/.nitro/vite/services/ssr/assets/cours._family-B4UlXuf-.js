...
import { n as markCoursItemViewed } from "./progress-ColVlCyh.js";
...
import { t as Route } from "./cours._family-ILvitZ2O.js";
import { n as useAnimationSpeed, t as scaleDuration } from "./useAnimationSpeed-8KgMYO7Q.js";
import { n as FAMILY_ORDER, t as EXERCISE_CATALOG } from "./sign-exercise-catalog-2qXNd-Hz.js";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, CheckCircle2, ChevronLeft, ChevronRight, Play, RotateCcw, Volume2 } from "lucide-react";
//#region src/routes/cours.$family.tsx?tsr-split=component
var familyColors = {
	point: {
		color: "#4A3B2A",
		bg: "#FBF6EC"
...
function CoursFamilyScreen() {
	...
	const [selectedSign, setSelectedSign] = useState(entries.length > 0 ? entries[0] : null);
	...
	const [pathLength, setPathLength] = useState(1e3);
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsxs("header", {
		...
		children: [
			selectedSign && /* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs(CahierFrame, {
						className: "relative w-[240px] h-[240px] flex items-center justify-center my-2",
						rounded: 16,
						children: [startEndMerged ? isPlaying && animProgress <= .98 && /* @__PURE__ */ jsx("div", {
						...
						}) : /* @__PURE__ */ jsxs(Fragment, { children: [isPlaying && animProgress <= .9 && /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", { className: "w-1 h-1 rounded-full bg-white" })
						}), isPlaying && animProgress <= .98 && /* @__PURE__ */ jsx("div", {
							...
							children: [
								...
								isPlaying && animProgress <= .98 && /* @__PURE__ */ jsx("circle", {
									cx: penPos.x,
									cy: penPos.y,
									r: 4.5,
									fill: "#A9784F",
					...
					return /* @__PURE__ */ jsxs("button", {
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: isSelected && /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-secondary fill-secondary/20 shrink-0 animate-bounce" })
							}),
							/* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [prevFamily ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => navigate({
						to: "/cours/$family",
					...
					children: [/* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4" }), t.common.back]
				}) : /* @__PURE__ */ jsx("div", {}), nextFamily ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => navigate({
						to: "/cours/$family",
					...
					children: [t.common.next, /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4" })]
				}) : /* @__PURE__ */ jsx("div", {})]
			})
		]
	})] });
