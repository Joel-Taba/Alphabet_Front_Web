...
import { t as Route } from "./cours._family-wzgEPuJN.js";
...
import { ArrowLeft, CheckCircle2, ChevronRight, Play, RotateCcw, Volume2 } from "lucide-react";
		...
		children: [
			selectedSign && /* @__PURE__ */ jsxs("section", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						className: "relative w-[240px] h-[240px] bg-[#FBF6EC] rounded-2xl border-2 border-dashed border-[#A9784F]/30 shadow-inner flex items-center justify-center overflow-hidden my-2",
						children: [isPlaying && animProgress <= .9 && /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: /* @__PURE__ */ jsxs("button", {
					...
					className: "w-full py-4 rounded-2xl bg-[#8FBF6F] hover:bg-[#7AAE5A] text-white font-extrabold text-lg shadow-lg flex items-center justify-center gap-3 transition-all active:scale-[0.99]",
					children: [/* @__PURE__ */ jsxs("span", { children: [
						"Passer aux Exercices (",
						familyInfo.title,
						")"
					] }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-6 w-6 stroke-[3]" })]
				})
			})
		]
	})] });
