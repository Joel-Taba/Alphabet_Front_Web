...
import { a as MAJUSCULES, c as familleDominante, n as COULEUR_FAMILLE, o as MINUSCULES, t as CHIFFRES } from "./flores-gong-nota-yzkWzvbf.js";
import { Link, Outlet, useMatchRoute, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, Lock, Volume2 } from "lucide-react";
//#region src/routes/cours.lettres.tsx?tsr-split=component
...
function GridSection({ titre, sous_titre, formules, onNavigate }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
			...
			children: titre
		}), sous_titre && /* @__PURE__ */ jsx("p", {
			className: "text-[12px] text-[#7A6A55] mt-0.5",
			children: sous_titre
		})] }), /* @__PURE__ */ jsx("div", {
			className: "grid grid-cols-6 gap-2",
			children: formules.map((f) => /* @__PURE__ */ jsx(LetterCell, {
				formule: f,
				onNavigate
			}, f.caractere))
		})]
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsxs("header", {
		...
		children: [
			/* @__PURE__ */ jsx("div", {
				...
				children: familles.map(({ famille, label, couleur }) => /* @__PURE__ */ jsxs("div", {
