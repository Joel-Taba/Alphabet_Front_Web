...
import { t as Route } from "./cours.lettres._char-BFTK30eF.js";
import { c as familleDominante, i as LABEL_ZONE, n as COULEUR_FAMILLE, r as FORMULES_PAR_CARACTERE, s as STROKE_FAMILLE } from "./flores-gong-nota-yzkWzvbf.js";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, BookOpen } from "lucide-react";
//#region src/routes/cours.lettres.$char.tsx?tsr-split=component
...
function AffichageLettreSeyès({ formule, lang }) {
	...
	return /* @__PURE__ */ jsxs(CahierFrame, {
		...
		children: [
			...
			signePrincipal && /* @__PURE__ */ jsx("div", {
				className: "absolute inset-0 flex items-center justify-center pointer-events-none",
...
function DecompositionScreen() {
	...
	if (!formule) return /* @__PURE__ */ jsx(MobileShell, { children: /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsx("header", {
		...
		children: [
			!formule.validee && /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				}), /* @__PURE__ */ jsx(AffichageLettreSeyès, {
					formule,
					lang
				})]
			}),
			[
				...
				"d",
				"q"
			].includes(formule.caractere) && /* @__PURE__ */ jsxs("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsx(BookOpen, { className: "h-5 w-5" }), t.coursLettresChar.practiceLink]
				}), /* @__PURE__ */ jsx(Link, {
					to: "/cours/lettres",
