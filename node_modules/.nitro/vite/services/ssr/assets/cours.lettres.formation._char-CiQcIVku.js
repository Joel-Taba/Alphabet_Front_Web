...
import { i as zOrderedStepIndices } from "./SignGlyph-BH0B_An9.js";
...
import { i as LETTER_GROUPS, t as getLetterFormation } from "./letter-style-resolver-DOxN1AFB.js";
import { a as useSignSpeech } from "./useSignSpeech-BDGf_vV1.js";
import { t as useWritingStyle } from "./useWritingStyle-CKn53fOs.js";
import { t as Route } from "./cours.lettres.formation._char-CCtwOcXm.js";
import { i as lettersForGroup, n as getPalier2GroupMap } from "./palier2-groups-Fh5LUE31.js";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [prevLetter ? /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4 rtl:rotate-180" }), t.common.previous]
					...
					children: [t.common.next, /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 rtl:rotate-180" })]
				}) : /* @__PURE__ */ jsx("div", {})]
			})
		]
	})] });
...
function LetterAnimationCanvas({ letter, speak, navigate, t, lang, pg, groupCode, totalItems }) {
	...
	return /* @__PURE__ */ jsxs("section", {
		...
		children: [/* @__PURE__ */ jsxs(CahierFrame, {
