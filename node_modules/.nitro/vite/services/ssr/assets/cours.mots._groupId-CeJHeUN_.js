...
import { t as Route } from "./cours.mots._groupId-BbUDOEfa.js";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [prevGroup ? /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4" }), prevGroup.title[lang]]
					...
					children: [nextGroup.title[lang], /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4" })]
				}) : /* @__PURE__ */ jsx("div", {})]
			})
		]
	})] });
