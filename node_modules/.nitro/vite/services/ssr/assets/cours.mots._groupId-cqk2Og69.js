...
import { t as Route } from "./cours.mots._groupId-BTDBSOrt.js";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, ChevronLeft, ChevronRight, Play, Volume2 } from "lucide-react";
//#region src/routes/cours.mots.$groupId.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsx("header", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", {
				...
				children: group.words.map((word) => /* @__PURE__ */ jsx(WordCard, {
					word,
					lang,
					speak,
					style: writingStyle,
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(AmaniMascot, {
					...
					children: [/* @__PURE__ */ jsx("span", { children: format(t.coursMots.practiceGroup, { titre: groupTitle }) }), /* @__PURE__ */ jsx(Play, { className: "h-5 w-5 fill-current" })]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "flex items-center justify-between gap-3 pt-1",
				children: [prevGroup ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => navigate({
					...
					children: [/* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4 rtl:rotate-180" }), prevGroup.title[lang]]
				}) : /* @__PURE__ */ jsx("div", {}), nextGroup ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => navigate({
						to: "/cours/mots/$groupId",
					...
					children: [nextGroup.title[lang], /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 rtl:rotate-180" })]
				}) : /* @__PURE__ */ jsx("div", {})]
			})
		]
	})] });
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [letters.map((letter, i) => /* @__PURE__ */ jsx(LetterTraceCell, {
				...
				isActive: false,
				given: true
			}, `${word.id}-${i}`)), letters.length === 0 && /* @__PURE__ */ jsx("span", {
			...
			children: /* @__PURE__ */ jsx(Volume2, { className: "w-4.5 h-4.5" })
		})]
	});
}
//#endregion
