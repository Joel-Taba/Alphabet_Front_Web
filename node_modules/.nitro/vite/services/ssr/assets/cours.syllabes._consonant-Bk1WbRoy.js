...
import { t as Route } from "./cours.syllabes._consonant-C1NeyIaK.js";
import { n as findSyllableGroupForConsonant, r as lettersForExampleWord, t as SYLLABLE_GROUPS } from "./syllable-catalog-BQgLw3Pq.js";
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [syllableIdx > 0 ? /* @__PURE__ */ jsxs("button", {
					...
					className: "flex items-center gap-2 px-5 py-3 rounded-full bg-[#A9784F] text-white font-bold text-[14px] shadow-md active:scale-95 transition-transform",
					children: [format(t.coursSyllabes.nextConsonant, { consonant: nextConsonantGroup.consonant }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4" })]
				}) : /* @__PURE__ */ jsx("div", {})]
			})
		]
	})] });
