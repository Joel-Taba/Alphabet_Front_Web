...
import { t as Route } from "./cours.syllabes._consonant-CwvBYtjC.js";
import { n as findSyllableGroupForConsonant, r as lettersForExampleWord, t as SYLLABLE_GROUPS } from "./syllable-catalog-7anoMDUA.js";
import { useEffect, useRef, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, ChevronLeft, ChevronRight, Play, RotateCcw, Volume2 } from "lucide-react";
//#region src/routes/cours.syllabes.$consonant.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsx("header", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("section", { children: /* @__PURE__ */ jsx("div", {
				...
				children: group.syllables.map((s, i) => /* @__PURE__ */ jsx("button", {
					type: "button",
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [syllableIdx > 0 ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					...
					children: [
						/* @__PURE__ */ jsx(ChevronLeft, { className: "h-4 w-4 rtl:rotate-180" }),
						"\"",
						group.syllables[syllableIdx - 1].syllable,
						"\""
					]
				}) : /* @__PURE__ */ jsx("div", {}), syllableIdx < group.syllables.length - 1 ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => goToSyllable(syllableIdx + 1),
					...
					children: [
						...
						group.syllables[syllableIdx + 1].syllable,
						"\"",
						/* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 rtl:rotate-180" })
					]
				}) : nextConsonantGroup ? /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => navigate({
					...
					className: "flex items-center gap-2 px-5 py-3 rounded-full bg-[#A9784F] text-white font-bold text-[14px] shadow-md active:scale-95 transition-transform",
					children: [format(t.coursSyllabes.nextConsonant, { consonant: nextConsonantGroup.consonant }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-4 w-4 rtl:rotate-180" })]
				}) : /* @__PURE__ */ jsx("div", {})]
			})
		]
	})] });
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: exampleLetters.map((l, i) => /* @__PURE__ */ jsx(LetterTraceCell, {
							letter: l,
							size: 40,
							isActive: false,
							given: true
...
function MiniLetterFrame({ letter, playKey, delayMs }) {
	if (!letter) return /* @__PURE__ */ jsx(CahierFrame, {
		className: "w-[76px] h-[76px] shrink-0",
		rounded: 12
	});
	return /* @__PURE__ */ jsx(CahierFrame, {
		className: "w-[76px] h-[76px] shrink-0 flex items-center justify-center",
		rounded: 12,
		children: /* @__PURE__ */ jsx("svg", {
			viewBox: "0 0 200 200",
			className: "w-full h-full",
			children: letter.steps.map((step, i) => /* @__PURE__ */ jsx(AnimatedStroke, {
				pathD: step.pathD,
