...
//#region src/components/amani/HelpBubble.tsx
...
//#endregion
//#region src/routes/exercice-intro.tsx?tsr-split=component
function ExerciceIntro() {
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsxs("header", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("span", { className: "w-11" })
		]
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx(AmaniMascot, {
					...
					size: "hero",
					priority: true
				}), /* @__PURE__ */ jsxs(HelpBubble, { children: [
					"On va ",
					/* @__PURE__ */ jsx("strong", { children: "reconnaître des signes" }),
					" ensemble !"
				] })]
			}),
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("p", {
					...
					children: Array.from({ length: 6 }).map((_, i) => /* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx("div", { className: "h-3 w-8 rounded-full bg-disabled" })
						})
					}, i))
				})]
			}),
