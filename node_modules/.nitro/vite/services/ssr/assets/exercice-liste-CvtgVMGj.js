...
import { t as Route } from "./exercice-liste-Aop-7ywA.js";
...
import { n as FAMILY_ORDER, t as EXERCISE_CATALOG } from "./sign-exercise-catalog-B079etHa.js";
...
function SignExerciseRow({ entry, repetitions, tolerance, hideFamilyBadge, onEntryDone }) {
	...
	const badge = !hideFamilyBadge || entry.scale === "reduced" ? /* @__PURE__ */ jsx("span", {
...
function ExerciceListeScreen() {
	...
	const [doneSigns, setDoneSigns] = useState(/* @__PURE__ */ new Set());
	...
	if (progressionGroup) {
		...
		return /* @__PURE__ */ jsxs(MobileShell, { children: [
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: groupLetters.map((letter) => /* @__PURE__ */ jsxs(Link, {
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: /* @__PURE__ */ jsx(ChevronRight, { className: "w-5 h-5 stroke-[2.5] rtl:rotate-180" })
					})]
				}, letter.char))
			})
		] });
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [
		...
		allFamilyDone && !isEvaluation && /* @__PURE__ */ jsx(ExerciseCompletePopup, {
		...
		/* @__PURE__ */ jsx("section", {
			...
			children: grouped.map(({ titre, entries }) => /* @__PURE__ */ jsxs("div", {
				...
				children: [!family && /* @__PURE__ */ jsx("h2", {
					...
					children: titre
				}), entries.map((entry) => /* @__PURE__ */ jsx(SignExerciseRow, {
					entry,
					repetitions,
					tolerance,
