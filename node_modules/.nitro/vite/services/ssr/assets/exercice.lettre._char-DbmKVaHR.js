...
import { i as zOrderedStepIndices, r as stepZIndex } from "./SignGlyph-BH0B_An9.js";
...
import { t as MobileShell } from "./MobileShell-YeJooLSD.js";
import { t as CahierFrame } from "./CahierFrame-BHMoRBMv.js";
import { n as validateTrace, t as sampleSVGPath } from "./traceValidation-0BWpiBQq.js";
import { t as RepetitionRow } from "./RepetitionRow-BmlwYseo.js";
import { t as ExerciseCompletePopup } from "./ExerciseCompletePopup-CGTDa3cU.js";
import { o as VOWELS, t as getLetterFormation } from "./letter-style-resolver-DOxN1AFB.js";
import { a as useSignSpeech } from "./useSignSpeech-BDGf_vV1.js";
import { t as useWritingStyle } from "./useWritingStyle-CKn53fOs.js";
import { n as EvaluationTimerBadge, r as useCountdown, t as EvaluationCompleteOverlay } from "./EvaluationTimer-BH-3up6U.js";
import { t as Route } from "./exercice.lettre._char-KOd066Hr.js";
import { i as lettersForGroup, n as getPalier2GroupMap, r as getPalier2Groups, t as findGroupForChar } from "./palier2-groups-Fh5LUE31.js";
import { n as useExerciseSettings, t as readEvaluationDurationMinutes } from "./useExerciseSettings-BvMMYb-T.js";
...
function LetterExerciseScreen() {
	...
	const [doneSteps, setDoneSteps] = useState(/* @__PURE__ */ new Set());
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [
		isEvaluation && !evaluationExpired && /* @__PURE__ */ jsx(EvaluationTimerBadge, { remaining }),
		isEvaluation && evaluationExpired && /* @__PURE__ */ jsx(EvaluationCompleteOverlay, { onBack: () => navigate({ to: "/accueil" }) }),
		letterSuccess && !isEvaluation && /* @__PURE__ */ jsx(ExerciseCompletePopup, {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: letter.steps.map((step, i) => {
						...
						return /* @__PURE__ */ jsx(RepetitionRow, {
							entry: {
				...
				!allStepsDone ? /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Lock, { className: "w-6 h-6 text-[#4A3B2A]/40" }), /* @__PURE__ */ jsx("p", {
		...
		letterSuccess && isEvaluation && /* @__PURE__ */ jsx(LetterSuccessOverlay, {
			letter,
			nextLetter,
			groupId,
			isEvaluation,
...
function LetterDrawingCanvas({ letter, currentStepIdx, completedSteps, stepStatus, onStepStatusChange, onSuccess, onRetry, w, h }) {
	...
	return /* @__PURE__ */ jsxs(CahierFrame, {
					...
					children: [
						nextLetter && /* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsxs("span", { children: [
								...
								nextLetter.char,
								")"
							] }), /* @__PURE__ */ jsx(ChevronRight, { className: "w-4 h-4 stroke-[3] rtl:rotate-180" })]
						}),
						!nextLetter && isEvaluation && evaluationNextLetter && evaluationNextGroupId && /* @__PURE__ */ jsxs("button", {
							type: "button",
							onClick: () => navigate({
								to: "/exercice/lettre/$char",
