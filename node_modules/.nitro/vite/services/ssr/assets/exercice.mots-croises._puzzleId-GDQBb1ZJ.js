...
import { i as WORD_CATALOG } from "./word-catalog-C-fKc0oN.js";
import { n as CrosswordPlay, t as generateCrossword } from "./crosswordGenerator-BQOZBMav.js";
import { t as Route } from "./exercice.mots-croises._puzzleId-BpJ9QZ_U.js";
import { useMemo } from "react";
import { Link } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft } from "lucide-react";
//#region src/routes/exercice.mots-croises.$puzzleId.tsx?tsr-split=component
...
function CrosswordScreen() {
	...
	if (!level || !crossword) return /* @__PURE__ */ jsx(MobileShell, { children: /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [/* @__PURE__ */ jsx("header", {
		...
		children: /* @__PURE__ */ jsx(CrosswordPlay, {
			crossword,
			puzzleId,
			level
		})
