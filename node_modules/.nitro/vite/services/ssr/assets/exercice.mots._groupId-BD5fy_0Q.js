...
import { a as lettersForWord, n as PALIER3_GROUPS, r as PALIER3_GROUP_MAP, s as wordText } from "./word-catalog-DdEuxvtH.js";
import { n as EvaluationTimerBadge, r as useCountdown, t as EvaluationCompleteOverlay } from "./EvaluationTimer-BH-3up6U.js";
import { t as Route } from "./exercice.mots._groupId-MTwgh26f.js";
...
//#region src/routes/exercice.mots.$groupId.tsx?tsr-split=component
function WordExerciseScreen() {
	...
	const [doneWords, setDoneWords] = useState(/* @__PURE__ */ new Set());
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: group.words.map((word) => /* @__PURE__ */ jsx(WordTraceRow, {
						word,
						lang,
						speak,
				...
				allDone && isEvaluation && evaluationNextGroup && /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: format(t.exerciceMots.nextGroup, { titre: evaluationNextGroup.title[lang] }) }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5 rtl:rotate-180" })]
				})
			]
		})
	] });
