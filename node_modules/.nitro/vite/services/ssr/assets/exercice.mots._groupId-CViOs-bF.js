...
import { a as lettersForWord, n as PALIER3_GROUPS, r as PALIER3_GROUP_MAP, s as wordText } from "./word-catalog-Tmy_ga3k.js";
import { n as EvaluationTimerBadge, r as useCountdown, t as EvaluationCompleteOverlay } from "./EvaluationTimer-Cbwzz98E.js";
import { t as Route } from "./exercice.mots._groupId-BUxoyCWs.js";
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				allDone && isEvaluation && evaluationNextGroup && /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: format(t.exerciceMots.nextGroup, { titre: evaluationNextGroup.title[lang] }) }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5" })]
				})
			]
		})
	] });
