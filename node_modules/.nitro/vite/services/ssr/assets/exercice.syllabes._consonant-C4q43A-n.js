...
import { t as Route } from "./exercice.syllabes._consonant-DdRk71CB.js";
import { i as lettersForSyllable, n as findSyllableGroupForConsonant, t as SYLLABLE_GROUPS } from "./syllable-catalog-GrCrYzgn.js";
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				allDone && isEvaluation && evaluationNextGroup && /* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx("span", { children: format(t.exerciceSyllabes.nextGroup, { consonant: evaluationNextGroup.consonant }) }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5" })]
				})
			]
		})
	] });
