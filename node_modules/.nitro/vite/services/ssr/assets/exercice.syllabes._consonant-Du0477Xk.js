...
import { t as Route } from "./exercice.syllabes._consonant-Bl9dObTh.js";
import { i as lettersForSyllable, n as findSyllableGroupForConsonant, t as SYLLABLE_GROUPS } from "./syllable-catalog-7anoMDUA.js";
import { t as readEvaluationDurationMinutes } from "./useExerciseSettings-BvMMYb-T.js";
import { useCallback, useEffect, useMemo, useState } from "react";
import { Link, useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { ArrowLeft, ChevronRight, Volume2 } from "lucide-react";
//#region src/routes/exercice.syllabes.$consonant.tsx?tsr-split=component
function SyllableExerciseScreen() {
	...
	const [doneSyllables, setDoneSyllables] = useState(/* @__PURE__ */ new Set());
	...
	if (!group) return /* @__PURE__ */ jsx(MobileShell, { children: /* @__PURE__ */ jsxs("div", {
	...
	return /* @__PURE__ */ jsxs(MobileShell, { children: [
		...
		allDone && !isEvaluation && /* @__PURE__ */ jsx(ExerciseCompletePopup, {
		...
		/* @__PURE__ */ jsxs("div", {
			...
			children: [
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: group.syllables.map((entry) => /* @__PURE__ */ jsx(SyllableTraceRow, {
						entry,
						speak,
				...
				allDone && isEvaluation && evaluationNextGroup && /* @__PURE__ */ jsxs("button", {
					type: "button",
					onClick: () => navigate({
					...
					children: [/* @__PURE__ */ jsx("span", { children: format(t.exerciceSyllabes.nextGroup, { consonant: evaluationNextGroup.consonant }) }), /* @__PURE__ */ jsx(ChevronRight, { className: "h-5 w-5 rtl:rotate-180" })]
				})
			]
		})
	] });
...
function SyllableTraceRow({ entry, speak, done, onDone, doneLabel, exampleWordPrefix, style }) {
	...
	const [solvedIdx, setSolvedIdx] = useState(/* @__PURE__ */ new Set());
	const handleLetterSolved = useCallback((idx) => {
		setSolvedIdx((prev) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: letters.map((letter, i) => /* @__PURE__ */ jsx(LetterTraceCell, {
				letter,
				size: 72,
