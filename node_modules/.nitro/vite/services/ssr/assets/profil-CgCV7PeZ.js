...
import { d as setStoredPhoto, l as setStoredName, r as getStoredPhoto, u as setStoredPassword } from "./profileAuth-wAmuDTHN.js";
import { t as resizeImageToDataUrl } from "./resizeImageToDataUrl-CuZ5Km1N.js";
import { useEffect, useRef, useState } from "react";
import { useNavigate } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { Camera, ChevronDown, Eye, EyeOff, Globe, Lock } from "lucide-react";
//#endregion
//#region src/routes/profil.tsx?tsr-split=component
...
function ProfileCreate() {
	...
	return /* @__PURE__ */ jsx(MobileShell, { children: /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [
					/* @__PURE__ */ jsx(LeafIcon, { className: "w-9 h-9 mb-1" }),
					/* @__PURE__ */ jsxs("div", {
						className: "flex items-center gap-3",
						children: [
							/* @__PURE__ */ jsx(LeafAccent, {}),
							/* @__PURE__ */ jsx("h1", {
								className: "text-[34px] font-bold leading-tight",
								style: { color: "#A9784F" },
								children: t.onboarding.title
							}),
							/* @__PURE__ */ jsx(LeafAccent, { flip: true })
						]
					}),
					/* @__PURE__ */ jsx("p", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsxs("button", {
							...
							children: LANGUAGES.map((l) => /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx("button", {
								type: "button",
								role: "option",
