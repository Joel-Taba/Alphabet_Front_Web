...
const CURSIVE_LITERAL_RAW: CursiveLiteralLetterInput[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { family: "trait", pathD: "M 108.45 103.12 L 133.35 103.12" },
    ],
  },
  {
    char: "d",
    zone: "hampe",
    steps: [
      { family: "trait", pathD: "M 54.75 125 L 80.8 100.01" },
      {
        family: "courbe",
  ...
  },
  {
    ...
    zone: "corps",
    steps: [
      { family: "courbe", pathD: "M 46.85 84.56 C 46.85 79.26 51.13 75 56.41 75 C 61.68 75 65.96 79.26 65.96 84.56 L 65.96 125" },
      { family: "courbe", pathD: "M 65.96 84.56 C 65.96 79.26 70.22 75 75.51 75 C 80.79 75 85.06 79.26 85.06 84.56 L 85.06 125" },
      {
        family: "courbe",
  ...
  },
  {
    ...
    zone: "corps",
    steps: [
      { family: "courbe", pathD: "M 73.41 84.56 C 73.41 79.26 77.67 75 82.96 75 C 88.23 75 92.51 79.26 92.51 84.56 L 92.51 125" },
      {
        family: "courbe",
  ...
  },
  {
    ...
    zone: "jambe",
    steps: [
      { family: "crochet", pathD: "M 81.33 125 L 109.98 95.32 A 13.75 13.75 0 0 0 99.85 72.01" },
      { family: "crochet", pathD: "M 111.13 77.11 A 10.74 10.74 0 0 0 91.27 82.7 L 91.27 126.99" },
      { family: "crochet", pathD: "M 91.27 126.99 L 91.27 168.26 A 13.75 13.75 0 0 0 114.73 177.98" },
      { family: "crochet", pathD: "M 103.26 181.74 A 13.75 13.75 0 0 0 115.77 159.62 L 90.37 127.07" },
      { family: "crochet", pathD: "M 91.42 137.51 A 5.16 5.16 0 0 0 100.3 141.02 L 111.05 129.88" },
    ],
  },
  {
    char: "k",
  ...
  },
  {
    ...
    zone: "jambe",
    steps: [
      { family: "trait", pathD: "M 51.01 128.75 L 68.28 100.01" },
      {
        family: "courbe",
  ...
  },
  {
    ...
    zone: "hampe",
    steps: [
      { family: "crochet", pathD: "M 66.42 84.65 L 104.47 39.84 A 11 16 0 0 0 104.47 15" },
      { family: "crochet", pathD: "M 105.6 16.63 A 12.29 17.86 0 0 0 84.62 29.26 L 84.62 124.25" },
      { family: "crochet", pathD: "M 84.74 89.25 A 13.09 19.03 0 0 1 107.54 100.98 L 108.41 125" },
    ],
  },
  {
    char: "A",
