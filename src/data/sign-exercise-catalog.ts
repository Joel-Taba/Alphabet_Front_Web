export type SignFamily = "trait" | "courbe" | "crochet" | "point";
export type SignVariant =
  ...
  | "double-crochet-gauche-droit"
  | "double-crochet-droit-gauche"
  | "center";
...
export interface SignExercise {
  ...
  /** Où le tracé s'arrête. Identique à startXY quand le signe se referme sur lui-même (ex. un point, une courbe fermée) — voir StartEndMarker. */
  endXY: [number, number];
  zone: "hampe" | "corps" | "jambe";
  strokeColor: string;
  badgeBg: string;
  badgeText: string;
}

export const TRAITS: SignExercise[] = [
  {
    id: "trait-vertical-full",
    label: { fr: "Trait vertical", en: "Vertical line", es: "Trazo vertical" , ar: "خط عمودي" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit trait vertical", en: "Small vertical line", es: "Trazo vertical pequeño" , ar: "خط عمودي صغير" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Trait horizontal", en: "Horizontal line", es: "Trazo horizontal" , ar: "خط أفقي" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit trait horizontal", en: "Small horizontal line", es: "Trazo horizontal pequeño" , ar: "خط أفقي صغير" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Trait oblique à gauche", en: "Diagonal line to the left", es: "Trazo oblicuo a la izquierda" , ar: "خط مائل إلى اليسار" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Trait oblique à droite", en: "Diagonal line to the right", es: "Trazo oblicuo a la derecha" , ar: "خط مائل إلى اليمين" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit oblique à gauche", en: "Small left diagonal", es: "Oblicuo a la izquierda pequeño" , ar: "مائل صغير إلى اليسار" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit oblique à droite", en: "Small right diagonal", es: "Oblicuo a la derecha pequeño" , ar: "مائل صغير إلى اليمين" },
    consigne: {
...
export const COURBES: SignExercise[] = [
  {
    id: "courbe-open-right-full",
    label: { fr: "Courbe ouverte à droite", en: "Curve open to the right", es: "Curva abierta a la derecha" , ar: "منحنى مفتوح من اليمين" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petite courbe à droite", en: "Small curve to the right", es: "Curva pequeña a la derecha" , ar: "منحنى صغير من اليمين" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Courbe ouverte à gauche", en: "Curve open to the left", es: "Curva abierta a la izquierda" , ar: "منحنى مفتوح من اليسار" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petite courbe à gauche", en: "Small curve to the left", es: "Curva pequeña a la izquierda" , ar: "منحنى صغير من اليسار" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Cercle fermé", en: "Closed circle", es: "Círculo cerrado" , ar: "دائرة مغلقة" },
    consigne: {
...
export const CROCHETS: SignExercise[] = [
  {
    id: "crochet-top-right-full",
    label: { fr: "Crochet haut-droite", en: "Top-right hook", es: "Gancho arriba-derecha" , ar: "خطاف أعلى اليمين" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Crochet haut-gauche", en: "Top-left hook", es: "Gancho arriba-izquierda" , ar: "خطاف أعلى اليسار" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Crochet bas-droite", en: "Bottom-right hook", es: "Gancho abajo-derecha" , ar: "خطاف أسفل اليمين" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Crochet bas-gauche", en: "Bottom-left hook", es: "Gancho abajo-izquierda" , ar: "خطاف أسفل اليسار" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet gauche", en: "Left double hook", es: "Bucle izquierdo" , ar: "حلقة مزدوجة يسرى" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet droit", en: "Right double hook", es: "Bucle derecho" , ar: "حلقة مزدوجة يمنى" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet gauche-droit", en: "Left-right double hook", es: "Bucle izquierda-derecha" , ar: "حلقة مزدوجة يسار-يمين" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet droit-gauche", en: "Right-left double hook", es: "Bucle derecha-izquierda" , ar: "حلقة مزدوجة يمين-يسار" },
    consigne: {
...
export const POINTS: SignExercise[] = [
  {
    id: "point-center-full",
    label: { fr: "Le Point", en: "The Dot", es: "El Punto" , ar: "النقطة" },
    consigne: {
...
export const EXERCISE_CATALOG: SignExercise[] = [
  ...TRAITS,
  ...COURBES,
  ...CROCHETS,
  ...POINTS
...
export const EXERCISE_MAP = new Map(EXERCISE_CATALOG.map((e) => [e.id, e]));

/** Ordre du Palier 1 (voir _app.accueil.tsx) : sert à la navigation entre les cours/exercices de chaque famille. */
export const FAMILY_ORDER: SignFamily[] = ["point", "courbe", "crochet", "trait"];
