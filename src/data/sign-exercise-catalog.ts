...
export const TRAITS: SignExercise[] = [
  {
    ...
    label: { fr: "Trait vertical", en: "Vertical line", es: "Trazo vertical" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit trait vertical", en: "Small vertical line", es: "Trazo vertical pequeño" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Trait horizontal", en: "Horizontal line", es: "Trazo horizontal" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit trait horizontal", en: "Small horizontal line", es: "Trazo horizontal pequeño" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Trait oblique à gauche", en: "Diagonal line to the left", es: "Trazo oblicuo a la izquierda" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Trait oblique à droite", en: "Diagonal line to the right", es: "Trazo oblicuo a la derecha" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit oblique à gauche", en: "Small left diagonal", es: "Oblicuo a la izquierda pequeño" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petit oblique à droite", en: "Small right diagonal", es: "Oblicuo a la derecha pequeño" },
    consigne: {
...
export const COURBES: SignExercise[] = [
  {
    ...
    label: { fr: "Courbe ouverte à droite", en: "Curve open to the right", es: "Curva abierta a la derecha" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petite courbe à droite", en: "Small curve to the right", es: "Curva pequeña a la derecha" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Courbe ouverte à gauche", en: "Curve open to the left", es: "Curva abierta a la izquierda" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Petite courbe à gauche", en: "Small curve to the left", es: "Curva pequeña a la izquierda" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Cercle fermé", en: "Closed circle", es: "Círculo cerrado" },
    consigne: {
...
export const CROCHETS: SignExercise[] = [
  {
    ...
    label: { fr: "Crochet haut-droite", en: "Top-right hook", es: "Gancho arriba-derecha" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Crochet haut-gauche", en: "Top-left hook", es: "Gancho arriba-izquierda" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Crochet bas-droite", en: "Bottom-right hook", es: "Gancho abajo-derecha" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Crochet bas-gauche", en: "Bottom-left hook", es: "Gancho abajo-izquierda" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet gauche", en: "Left double hook", es: "Bucle izquierdo" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet droit", en: "Right double hook", es: "Bucle derecho" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet gauche-droit", en: "Left-right double hook", es: "Bucle izquierda-derecha" },
    consigne: {
  ...
  },
  {
    ...
    label: { fr: "Double-crochet droit-gauche", en: "Right-left double hook", es: "Bucle derecha-izquierda" },
    consigne: {
...
export const POINTS: SignExercise[] = [
  {
    ...
    label: { fr: "Le Point", en: "The Dot", es: "El Punto" },
    consigne: {
