export const fr = {
  ...
  parcours: {
    ...
    paliers: [
      ...
      { title: "Les Syllabes", subtitle: "PALIER 3", tagline: "Assemble consonnes et voyelles pour lire" },
      { title: "Les Mots", subtitle: "PALIER 4", tagline: "Relie les lettres entre elles" },
    ],
  },
  community: {
...
type DeepReplace<T> = T extends string
  ...
  : T extends readonly (infer U)[]
    ? readonly DeepReplace<U>[]
    : T extends object
      ? { [K in keyof T]: DeepReplace<T[K]> }
      : T;

export type Dictionary = DeepReplace<typeof fr>;
...
export const en: Dictionary = {
  ...
  parcours: {
    ...
    paliers: [
      ...
      { title: "Syllables", subtitle: "TIER 3", tagline: "Blend consonants and vowels to read" },
      { title: "Words", subtitle: "TIER 4", tagline: "Link letters together" },
    ],
  },
  community: {
...
export const es: Dictionary = {
  ...
  parcours: {
    ...
    paliers: [
      ...
      { title: "Las Sílabas", subtitle: "NIVEL 3", tagline: "Combina consonantes y vocales para leer" },
      { title: "Las Palabras", subtitle: "NIVEL 4", tagline: "Une las letras entre sí" },
    ],
  },
  community: {
...
export const ar: Dictionary = {
  ...
  parcours: {
    ...
    paliers: [
      ...
      { title: "المقاطع", subtitle: "المرحلة 3", tagline: "اجمع الحروف الساكنة والمتحركة للقراءة" },
      { title: "الكلمات", subtitle: "المرحلة 4", tagline: "اربط الحروف ببعضها" },
    ],
  },
  community: {
